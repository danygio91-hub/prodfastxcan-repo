...
export function buildMRPTimelines(
            ...
            if (item.status !== 'withdrawn') {
                ...
                if (mat) {
                    demands.push({
                        ...
                        date: job.assignedDate || '9999-12-31', // Usato per il sorting primario
                        deliveryDate: job.dataConsegnaFinale || '9999-12-31', // Usato per il sorting secondario
                        id: job.id
                    });
                }
            }
            ...
            art.billOfMaterials.forEach(item => {
                ...
                if (mat) {
                    demands.push({
                        ...
                        date: '9999-12-31', // Gli impegni manuali non hanno assignedDate, vanno in fondo
    ...
    // Sort demands: prima per data assegnata (Kanban), poi per data consegna

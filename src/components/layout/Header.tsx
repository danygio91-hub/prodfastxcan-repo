...
import { LogOut, RefreshCw, LayoutDashboard, ListChecks, Briefcase, BarChart3, Settings, Building2, Boxes, ShieldAlert, Timer, Combine, ClipboardList, Warehouse, History } from 'lucide-react';
...
const adminNavItems = [
  ...
  { href: '/admin/batch-management', label: 'Gestione Lotti', icon: History },
